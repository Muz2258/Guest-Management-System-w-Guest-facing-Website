<template>
  ...
  <transition appear name="slide-down">
    <header class="fixed top-0 w-screen z-50" :class="{'h-svh': showNavigation}">
      <div class="flex justify-center items-center py-16 px-24 bg-neutrals-neu-100/90 backdrop-blur-sm border-b border-neutrals-neu-90 relative" @click="toggleNavigation" role="button" aria-controls="navigation-menu" tabindex="0">
        <WeddingLogo />
