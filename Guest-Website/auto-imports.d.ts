...
declare global {
  ...
  const guestStorage: typeof import('@/utils/guestStorage.ts')['guestStorage']
  ...
  const supabase: typeof import('@/utils/supabase.ts')['supabase']
  ...
  const useGalleryStore: typeof import('./src/stores/gallery')['useGalleryStore']
