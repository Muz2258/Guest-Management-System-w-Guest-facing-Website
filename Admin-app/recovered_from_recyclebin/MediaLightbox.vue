        ...
        >
          ...
          <div v-else-if="item.file_type === 'video'" class="relative w-full h-full">
            ...
            <div v-if="!hideUI" class="absolute bottom-[8rem] left-0 right-0 flex items-center justify-center gap-12 z-100">
              <div class="flex items-center justify-center gap-8 py-8 px-12 bg-neutrals-neu-0/50 rounded-full border border-neutrals-neu-46/30" @click.stop="togglePlay(index)">
                ...
                <p class="flex gap-4 items-center justify-center text-neutrals-neu-100 text-s">
                  <span>{{ videoTimes[index]?.currentTime }}</span>
                  <span> / </span>
                  <span class="opacity-65">{{ videoTimes[index]?.duration }}</span>
                </p>
              </div>
              <div class="flex items-center justify-center p-8 bg-neutrals-neu-0/50 rounded-full border border-neutrals-neu-46/30" @click.stop="toggleMute(index)">
